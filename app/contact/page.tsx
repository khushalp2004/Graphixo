  ...
  return (
    <main className="max-w-6xl mx-auto py-12 px-4">
      <div className="text-center mb-16">
        <h1 className="text-4xl font-bold mb-4"><Link href="/">Graphi<span className='text-green-600'>X</span>o</Link> Contact</h1>
      ...
      <div className="grid md:grid-cols-2 gap-12">
        ...
        <div className="space-y-8">
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">support@graphixo.example.com</p>
                  <p className="text-gray-600">partnerships@graphixo.example.com</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">1234 Design Street</p>
          ...
          {/* Support Hours */}
          <div className="bg-purple-50 rounded-xl p-6 border border-purple-100">
            <h3 className="text-xl font-semibold mb-4 text-purple-800">Support Hours</h3>
          ...
          {/* Social Media */}
          <div className="bg-purple-50 rounded-xl p-6 border border-purple-100">
            <h3 className="text-xl font-semibold mb-4 text-purple-800">Follow Us</h3>
            <div className="flex gap-4">
              <a href="#" className="bg-purple-100 hover:bg-purple-200 p-3 rounded-full transition">
